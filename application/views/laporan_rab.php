...
<style>
	...
	#frm-ubah-rincian .select2-container--bootstrap .select2-selection--single {
		...
		padding: 1px 16px 6px 12px;

	}



	#frm-ubah-rincian .form-control[readonly] {
...
<div class="properties-area" style="padding: 30px 10px 17px;">
	<div class="container" style="width: 100%;">
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-12">
					<div class="alert alert-warning" role="alert" id="warning-ekspor">
						<i class="" style="padding-right: 5px;font-size: 20px;vertical-align: middle;"><img src="assets/warning.png" alt="" /></i> <span id="text-warning">Fitur ekspor
							data hanya tersedia apabila <strong>harga dasar</strong> pada
							<strong>rincian bahan, upah,</strong> dan
							<strong> lengkap.</strong></span>
					</div>
					<div class="btn-group pull-right">
						<div class="btn-group btn-group-info">
							<button class="btn btn-default btn-aksi-footer btn-ekspor" onclick="konfirmasiEkspor('semua')" style="width: 195px;padding: 8px 17px; color:#fff"><i class="fa"><img src="assets/ekspor.png" /></i>Ekspor Semua Data</button>
						</div>
					</div>
				</div>
								...
								<div class="panel-body">
									...
									<center>
										<div class="btn-group" style="margin-bottom: 10px;">
											<div class="btn-group btn-group-info">
												<button class="btn btn-default btn-ekspor btn-rincian" id="btn-ekspor-rincian-upah" style="width: 138px; background-color: #3EB549; border:0;border-top-left-radius:20px;border-bottom-left-radius:20px"><i class="fa fa-print"></i> Cetak</button>
												<button class="btn btn-default btn-reload btn-rincian" id="reload-rincian-upah" style="width: 138px; background-color: #1B68B0; border:0;"><i class="fa fa-upload" onclick="konfirmasiEkspor('rincian_upah')"></i> Ekspor</button>
												<button class="btn btn-default btn-reload btn-rincian" id="reload-rincian-bahan" style="width: 138px; border:0;border-top-right-radius:20px;border-bottom-right-radius:20px"><i class="fa fa-refresh"></i> Reload</button>
											</div>
										</div>
									</center>
									...
									<table id="tabel-rekap-harga-satuan" class="table table-striped table-advance">
										<thead>
											<tr>
												...
												<th width="9%" colspan="2">Sumber</th>
												<th width="3%"></th>
											</tr>
						...
						<div class="panel panel-default">
							...
							<div id="wrap-rab" class="panel-collapse collapse" role="tabpanel" aria-labelledby="rab">
								<div class="panel-body">
									...
									<table id="tabel-rab" class="table table-striped table-advance" style="width: 100%;font-size: 12px;">
										<thead>
											<tr>
												<th width="4%" rowspan="3">No.</th>
												<th width="20%" rowspan="3">Uraian Pekerjaan</th>
												<th width="10%" rowspan="3">Satuan</th>
												<th width="10%" rowspan="3">Volume</th>
												<th width="14%" colspan="3">Harga Satuan (Rp.)</th>
												<th colspan="6"></th>
												<!-- <th>Jumlah Harga</th>
												<th>Pros Pajak</th>
												<th>Pajak</th>
											...
											<tr>
												<th width="5%" rowspan="2">Upah</th>
												<th width="5%" rowspan="2">Bahan</th>
												<th width="4%" rowspan="2">Alat</th>
												<th colspan="2">Jasa/Upah</th>
									...
									<table class="table summary-rab" style="width: 100%;margin-bottom: 0;">
										<tbody>
											<tr>
												<td align="right" width="40%">Pelaksanaan Pekerjaan</td>
												<td align="right" width="10%" style="padding-left: 10px;"><span id="jum_harga">Rp.0,0</span></td>
												<td align="center" width="10%">0,0%</td>
											</tr>
											<tr>
												<td align="right">PPN 11%<span id="pros_pajak"></span></td>
												<td align="right"><span id="pajak"></span>Rp.0,0</td>
												<td align="center" width="10%">0,0%</td>
											</tr>
											<tr>
												<td align="right">TOTAL</td>
												<td align="right"><span id="total_harga">Rp.0,0</span></td>
												<td align="center" width="10%">0,0%</td>
											</tr>
										</tbody>
									</table>
							...
							<div id="wrap-rekap-rab" class="panel-collapse collapse" role="tabpanel" aria-labelledby="rekap-rab">
								<div class="panel-body">
									...
									<table class="table summary-rekap-rab" style="width: 100%;margin-bottom: 0;">
										<tbody>
											<tr>
												<td align="right" width="40%">JUMLAH HARGA</td>
												<td align="right" width="10%"><span id="rekap_jum_harga">Rp.0,0</span></td>
												<td align="right" width="10%" style="padding-left: 12px;">100.00 %</td>
											</tr>
											<tr>
												<td align="right">PPN <span id="rekap_pros_pajak"></span></td>
												<td align="right"><span id="rekap_pajak">Rp.0,0</span></td>
												<td align="right" width="10%" style="padding-left: 12px;">100.00 %</td>
											</tr>
											<tr>
												<td align="right">TOTAL HARGA</td>
												<td align="right"><span id="rekap_total_harga">Rp.0,0</span></td>
												<td align="right" width="10%" style="padding-left: 12px;">100.00 %</td>
											</tr>
											<tr>
												<td align="right">DIBULATKAN</td>
												<td align="right"><span id="rekap_harga_bulat">Rp.0,0</span></td>
												<td align="right" width="10%" style="padding-left: 12px;">100.00 %</td>
											</tr>
											<tr>
												<td align="right" colspan="2"><span id="rekap_terbilang">TERBILANG: Rupiah</span></td>
												<td></td>
											</tr>
										</tbody>
									</table>
							...
							<div id="wrap-rekap-bahan" class="panel-collapse collapse" role="tabpanel" aria-labelledby="rekap-bahan">
								<div class="panel-body">
									...
									<table class="table summary-rekap-bahan" style="width: 100%;margin-bottom: 0;">
										<tbody>
											<tr>
												<td align="right" width="62%">JUMLAH HARGA</td>
												<td align="right" width="16.5%"><span id="jum_bahan"></span></td>
												<td align="right" width="6.9%" style="padding-right: 17px;">100.00 %</td>
											</tr>
										</tbody>
									</table>
								...
								<div class="panel-body">
									...
									<table class="table summary-rekap-alat" style="width: 100%;margin-bottom: 0;">
										<tbody>
											<tr>
												<td align="right" width="62%">JUMLAH HARGA</td>
												<td align="right" width="16.5%"><span id="jum_alat"></span></td>
												<td align="right" width="6.9%"><span id="pros_harga" style="padding-right: 17px;"></span></td>
											</tr>
										</tbody>
									</table>
...
<script>
	$(document).ready(function() {
		$('#accordion .panel-title a:before').click(function() {
