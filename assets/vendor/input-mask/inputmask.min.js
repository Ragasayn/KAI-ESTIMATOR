...
var returnVal=eventHandler.apply(that,arguments);return trackCaret&&(trackCaret=!1,setTimeout(function(){caret(that,that.inputmask.caretPos)})),!1===returnVal&&(e.preventDefault(),e.stopPropagation()),returnVal}
