...
try {
    $images = Slim::getImages('image_upload');
}
catch (Exception $e) {
...
if (isset($image['output']['data'])) {
    ...
    $data = $image['output']['data'];
  	...
  	if ($image['meta']->profil == 'proyek') $dir_save = '../../../foto/proyek'; else $dir_save = '../../../foto/pengguna';
  
    if ($image['meta']->oldFoto != '') {
      	if ($image['meta']->oldFoto != 'no-foto.jpg' && $image['meta']->oldFoto != 'no_foto.jpg') {
          $path_image = $dir_save.'/'.$image['meta']->oldFoto;
    ...
    $output = Slim::saveFile($data, $name, $dir_save);
}
...
if (isset($image['input']['data'])) {
    ...
    $input = Slim::saveFile($data, $name, $dir_save);
}
